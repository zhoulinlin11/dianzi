...
public class XrvAdapter2 extends RecyclerView.Adapter {
    private Context context;
    private List<SatinBean.DataBean> data;
    private OnItemClickListener onItemClickListener;
    public XrvAdapter2(Context context, List<SatinBean.DataBean> data) {
